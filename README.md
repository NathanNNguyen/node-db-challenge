...
RDBMS and SQL are different in many ways. RDBMS have fixed or static predefined scheme while SQL have dynamic schema. While SQL is best suited for hier-archical data storage, RDBMS isn't so much. But on the other hand, RDBMS is best suited for complex queries, and it is verticlly scalable while SQL is horizontally.
...
A third table to connect the two
